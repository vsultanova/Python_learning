...
def main():
    ...
    if askuseroption.answer_option == 1:
        ...
        Homework7_CSV.write_letter_to_csv(Homework7_CSV.word_count()[1], Homework7_CSV.word_count()[2], Homework7_CSV.word_count()[3])
        exit()
...
class AskUserFile:
    ...
    def ask_user_file(self):
        self.answer_user_file = input("Please write a file name/path to get the data from? ")
